...
Sphere_0 = geompy.MakeSphereR(0.0436751)
geompy.TranslateDXDYDZ(Sphere_0, 5.44423, 6.85116, 2.88027)
Sphere_0.SetColor(SALOMEDS.Color(0, 1, 1))
geompy.addToStudy(Sphere_0, 'Bubble_0' )
Sphere_1 = geompy.MakeSphereR(0.270829)
geompy.TranslateDXDYDZ(Sphere_1, 6.91014, 6.53643, 8.89456)
Sphere_1.SetColor(SALOMEDS.Color(0, 1, 1))
geompy.addToStudy(Sphere_1, 'Bubble_1' )
Sphere_2 = geompy.MakeSphereR(0.41853)
geompy.TranslateDXDYDZ(Sphere_2, 7.32747, 2.93424, 2.54089)
Sphere_2.SetColor(SALOMEDS.Color(0, 1, 1))
geompy.addToStudy(Sphere_2, 'Bubble_2' )
Sphere_3 = geompy.MakeSphereR(0.319461)
geompy.TranslateDXDYDZ(Sphere_3, 6.25714, 1.17254, 0.872149)
Sphere_3.SetColor(SALOMEDS.Color(0, 1, 1))
geompy.addToStudy(Sphere_3, 'Bubble_3' )
Sphere_4 = geompy.MakeSphereR(0.0842074)
geompy.TranslateDXDYDZ(Sphere_4, 1.75626, 3.83339, 3.09978)
